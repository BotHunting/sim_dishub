...
<head>
    ...
    <!-- JavaScript untuk membuat input pencarian otomatis menjadi huruf kapital -->
    <script>
            ...
            <table class="table table-bordered mt-3">
                ...
                <tbody>
                    ...
                    if ($result_search->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='7' class='text-center'>Tidak ada data numpang uji masuk.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
            ...
            <div class="mt-4">
                <ul class="pagination">
                    ...
                    for ($i = 1; $i <= $total_pages; $i++) {
                        echo "<li class='page-item " . ($i == $page ? 'active' : '') . "'><a class='page-link' href='numpanguji_masuk_find.php?page=$i'>$i</a></li>";
                    }
                    ?>
                </ul>
            </div>
