...
if (isset($_GET['jabatan'])) {
    ...
    // Query untuk mengambil bidang berdasarkan jabatan
    $query = "SELECT DISTINCT bidang FROM jabatan WHERE nama_jabatan = ?";
    ...
    if ($stmt) {
        ...
        if ($result && $result->num_rows > 0) {
            // Ambil hasil query dan simpan dalam variabel bidang
            ...
            // Jika tidak ada hasil, set bidang menjadi string kosong
            $bidang = '';
        }

        // Kembalikan data bidang dalam format teks
        echo $bidang;
    } else {
