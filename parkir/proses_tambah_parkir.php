...
$sql = "INSERT INTO parkir (lokasi, alamat, keterangan, foto) VALUES ('$lokasi', '$alamat', '$keterangan', '$nama_foto')";

if ($koneksi->query($sql) === TRUE) {
    // Jika berhasil, redirect kembali ke halaman tambah_parkir.php
    header("Location: tambah_parkir.php");
} else {
